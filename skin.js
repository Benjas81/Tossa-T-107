...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		el.ggAutoPosition = function(init) {
			var currYPos = 0;
			var numElements = me._clone_sala.ggInstances.length;
			var currElement = 0;
			for (var i=0; i<me._clone_sala.ggNumRows; i++) {
				var rowMaxHeight = 0;
				for (var j=0; j<me._clone_sala.ggNumCols; j++) {
					if (numElements > currElement) {
						me._clone_sala.childNodes[currElement].style['top'] = currYPos + 'px';
						me._clone_sala.childNodes[currElement].style['height'] ='0px';
						rowMaxHeight = Math.max(rowMaxHeight, me._clone_sala.childNodes[currElement].scrollHeight);
						me._clone_sala.childNodes[currElement].style['height'] = rowMaxHeight + 'px';
					}
					currElement++;
				}
		...
		el.ggUpdate = function(filter) {
			...
			me._clone_sala.ggAutoPosition(true);
			me._clone_sala.ggUpdating = false;
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		hs='data:image/svg+xml;base64,'+
	...
	function SkinCloner_clone_sala_Class(item, parentScope,ggParent,parameter) {
		...
		me.__div.setAttribute('style','position: absolute;width: 150px; height: 15px; visibility: inherit; overflow: visible;');
